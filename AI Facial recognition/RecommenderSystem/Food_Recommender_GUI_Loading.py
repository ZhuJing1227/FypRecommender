...
class foodwindow(QWidget):
    ...
    def __init__(self):
        ...
        foodchoice.setStyleSheet("color: #878280; margin-left:200px; border:0px solid black;")
        ...
        foodchoice1.setStyleSheet(
            "color: #DB8012; border:0px solid black;margin-right:400px; margin-left:120px; text-align:left; font-weight:bold;text-decoration: underline;")
