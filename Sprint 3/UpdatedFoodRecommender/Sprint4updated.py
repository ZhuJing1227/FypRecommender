...
class foodwindow(QWidget):
    def __init__(self):
        ...
        foodchoice.setStyleSheet("color: #DDE0E8; margin-left:250px; border:0px solid black;")
        foodchoice1.setFixedHeight(50)
        foodchoice1.setCursor(QCursor(Qt.PointingHandCursor))
        foodchoice1.setStyleSheet(" border:0px solid black;text-decoration: underline; color:#CDE5FF; background-color:none; margin-right:500px; margin-left:80px; text-align:left; font-weight:bold;")
