...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        title = "NYP Course Recommender App"
        ...
        lay.setContentsMargins(450,50,450,0)
...
class foodwindow(QWidget):
    def __init__(self):
        ...
        tittle.setStyleSheet("color: white;border-bottom: 1px solid white; padding-bottom:15px; border-bottom-width: 10px;")
        # tittle.setFont(QFont('Times', 11))
        layoutGrid.addWidget(tittle,0,0,1,0)
        foodchoice=QLabel("You've chosen: ")

        foodchoice1=QPushButton(most_looked)


        # layoutGrid.addWidget(foodchoice1,1,3,2,1)

        if (most_looked.find('SIT') != -1):
            foodchoice1.clicked.connect(lambda: webbrowser.open('https://www.nyp.edu.sg/content/dam/nyp/about-nyp/nyp-overview/media-room/publications/course-booklets/SIT%20Course%20Booklet.pdf'))
        elif (most_looked.find('SBM') != -1):
            foodchoice1.clicked.connect(lambda: webbrowser.open('https://www.nyp.edu.sg/content/dam/nyp/about-nyp/nyp-overview/media-room/publications/course-booklets/SBM%20Course%20Booklet.pdf'))
        elif (most_looked.find('SEG') != -1):
            foodchoice1.clicked.connect(lambda: webbrowser.open('https://www.nyp.edu.sg/content/dam/nyp/about-nyp/nyp-overview/media-room/publications/course-booklets/SEG%20Course%20Booklet.pdf'))
        elif (most_looked.find('SAS') != -1):
            foodchoice1.clicked.connect(lambda: webbrowser.open('https://www.nyp.edu.sg/content/dam/nyp/about-nyp/nyp-overview/media-room/publications/course-booklets/SAS%20Course%20Booklet.pdf'))
        elif (most_looked.find('SHSS') != -1):
            foodchoice1.clicked.connect(lambda: webbrowser.open('https://www.nyp.edu.sg/content/dam/nyp/about-nyp/nyp-overview/media-room/publications/course-booklets/SHSS%20Course%20Booklet.pdf'))
        elif (most_looked.find('SDM') != -1):
            foodchoice1.clicked.connect(lambda: webbrowser.open('https://www.nyp.edu.sg/content/dam/nyp/about-nyp/nyp-overview/media-room/publications/course-booklets/SDM%20Course%20Booklet.pdf'))
        else:
            print("Error in opening PDF for mostlooked")



        foodchoice.setStyleSheet("color: #DDE0E8; margin-left:200px; border:0px solid black;")
        foodchoice1.setFixedHeight(50)
        foodchoice1.setCursor(QCursor(Qt.PointingHandCursor))
        foodchoice1.setStyleSheet(" border:0px solid black;text-decoration: underline; color:#CDE5FF; background-color:none; margin-right:400px; margin-left:180px; text-align:left; font-weight:bold;")
        foodchoice1.setFont(QFont("Times New Roman",12))
        foodchoice2=QLabel("(Click to Find Out More!)")
        foodchoice2.setAlignment(Qt.AlignHCenter)
        foodchoice2.setFixedHeight(60)
        foodchoice2.setStyleSheet("color: #C5DCE1; border:0px solid black; background-color: none;padding-bottom: 15px; margin-right:10px;")
        ...
        for a, value in zip(a, food):
            ...
            foodname.setStyleSheet("color:#0E4557;background-color: #DDE0E8; padding :10px;font-weight: bold; ")
