...
while True:
    ...
    for index, current_face_location in enumerate(all_face_locations):
        ...
        # Predicting Gender
        # declaring the labels
        age_label_list = ['14 and below', '15 - 24', '25 - 54', '55 - 64', '65 and above']
        # declaring the file paths
        ...
        cv2.putText(current_frame, gender + " " + age, (left_pos, bottom_pos + 20), font, 0.5, (255, 0, 0), 1)
        print(gender)
        gender_frequency.append(gender)
        print(age)
        age_frequency.append(age)
...
age = frequency_table(age_frequency, age)
