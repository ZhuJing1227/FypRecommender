...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.setGeometry(0,0,500,500)
        self.pushButton2.setMinimumHeight(50)
        self.pushButton1.setMinimumHeight(40)
        self.pushButton2.setMinimumWidth(200)
        self.pushButton1.setMinimumWidth(200)
        self.pushButton1.resize(300,300)
    ...
    def plot(self):
            ...
            counter = 0
            mp_img = mpimg.imread("whatsfordinner1x.png")
...
class GridDemo(QWidget):
    ...
    def ui(self):
        ...
        if imagechooser =="imagechooser1":
            print("1")
            self.image.setStyleSheet("border-image: url(whatsfordinner1x.png);")
            self.layoutGrid.addWidget(self.image)
        elif imagechooser=="imagechooser2":
            print("2")
            self.image.setStyleSheet("border-image: url(whatsfordinner2x.png);")
            self.layoutGrid.addWidget(self.image)
        elif imagechooser=="imagechooser3":
            print("3")
            self.image.setStyleSheet("border-image: url(whatsfordinner3x.png);")
            self.layoutGrid.addWidget(self.image)
        else:
            print("Error")
...
class okk(QWidget):
    ...
    def ui2(self):
        ...
        if image=="imagechooser1":
            ...
            mp_img = mpimg.imread("whatsfordinner2x.png")
        elif image=="imagechooser3":
            mp_img = mpimg.imread("whatsfordinner3x.png")
...
class foodwindow(QWidget):
    ...
    def __init__(self):
        ...
        positions = [(r, c) for r in range(2) for c in range(5)]
        ...
        for positions, value in zip(positions, food):
            ...
            # foodname.setStyleSheet("background-color: blue;")
            foodname.setFont(QFont('Arial', 10))
            foodname.setStyleSheet("background-color: lightblue")
            ...
            location.setMaximumHeight(50)
            location.setAlignment(Qt.AlignHCenter)
            location.setStyleSheet("background-color: lightblue ; padding: 5px")
        ...
        layoutGrid.addWidget(backbutton,2, 2, 1, 1)
