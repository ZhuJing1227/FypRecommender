    ...
    def eyetracker(self):
        ...
        if imagechooser == 'imagechooser3':
            ...
            if max(rank) == rank[0]:
                ...
                most_looked = 'Current Affairs and Debating Club'
            else:
                print("Smth went very wrong")
        ...
        if imagechooser == 'imagechooser4':
            ...
            if max(rank) == rank[0]:
                ...
                most_looked = 'Lion and Dragon Dance Troupe'
            elif max(rank) == rank[6]:
        ...
        if imagechooser == 'imagechooser11':
            ...
            if max(rank) == rank[0]:
                ...
                most_looked = 'Stagearts Drama and Theatre Management Club'
            elif max(rank) == rank[2]:
...
class ccawindow(QWidget):
    ...
    def __init__(self):
        ...
        ccachoice = QLabel("You've picked: ")
        ...
        maps = {'Adventure Club': 'https://www.nyp.edu.sg/student-life/cca/sports-and-adventure/adventure-club.html',
                ...
                'Current Affairs and Debating Club':'https://www.nyp.edu.sg/student-life/cca/leadership-and-character-development/current-affairs-and-debating-club.html',
                ...
                'Lion and Dragon Dance Troupe':'https://www.nyp.edu.sg/student-life/cca/sports-and-adventure/lion-and-dragon-dance-troupe.html',
                ...
                'Stagearts Drama and Theatre Management Club':'https://www.nyp.edu.sg/student-life/cca/arts-and-culture/stagearts.html',
        ...
        ccachoice2 = QLabel("(Click to Find Out More!)")
        ...
        for a, value in zip(a, cca):
            ...
            ccaname.setStyleSheet("color: #5E636D;  padding :10px; font-weight: Semi Bold;")
            ccaname.setToolTip('<font color="red" >Click on the <b>Image</b> to view the info of the place</font>')
            ...
            if value == "Adventure Club":
                ...
                website.setWordWrap(True)
                vbox.addWidget(website)
            elif value == "Current Affairs and Debating Club":
                images.setStyleSheet("border-image : url(ccaimages/Current Affairs and Debating Club.png);")
                ...
                website.setWordWrap(True)
                vbox.addWidget(website)
            elif value == "Lion and Dragon Dance Troupe":
                images.setStyleSheet("border-image : url(ccaimages/Lion and Dragon Dance Troupe.png);")
                ...
                website.setWordWrap(True)
                vbox.addWidget(website)
            elif value == "Stagearts Drama and Theatre Management Club":
                images.setStyleSheet("border-image : url(ccaimages/Stagearts Drama and Theatre Management Club.png);")
